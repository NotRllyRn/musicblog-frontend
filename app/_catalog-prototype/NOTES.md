...
interaction surface: mouse and pen dragging tilt that surface, while supported
HTTPS phones use calibrated device orientation after any required permission.
Reduced-motion, denied, and unsupported clients keep the sleeve flat. The
